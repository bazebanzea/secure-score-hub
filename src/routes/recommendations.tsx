...
import { recommendations, domains } from "@/lib/mock-data";
...
function RecoPage() {
  const totalGain = recommendations.reduce((a, r) => a + r.impact, 0);
  return (
    <div className="p-6 lg:p-8 space-y-6">
      ...
      <div className="space-y-3">
        {recommendations.map((r, i) => {
          ...
          return (
            <Card key={r.id} className="bg-gradient-panel p-5 hover:border-primary/40 transition-all">
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md border border-primary/40 bg-primary/10 font-mono text-sm text-primary">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-3 flex-wrap">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-mono text-success font-bold text-glow">+{r.impact}</span>
                    </div>
                  </div>
